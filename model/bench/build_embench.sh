...
SRC=${2:?}
TC=/home/chips/Storage/kushal/profiler/riscv-gnu-toolchain-rv32ic/bin
...
$TC/riscv32-unknown-elf-gcc $FLAGS -T link_spike.ld -o ${NAME}_spike.elf $COMMON report_spike.c 2>&1 | grep -v RWX || true
$TC/riscv32-unknown-elf-gcc $FLAGS -T link_rtl.ld   -o ${NAME}_rtl.elf   $COMMON report_rtl.c report_rtl_io.c 2>&1 |  grep -v RWX || true
$TC/riscv32-unknown-elf-objcopy -O verilog ${NAME}_rtl.elf ${NAME}_rtl.hex
